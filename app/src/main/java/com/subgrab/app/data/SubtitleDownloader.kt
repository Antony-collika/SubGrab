...
class SubtitleDownloader(
    ...
    suspend fun fetchAndPersistTranscript(
        ...
        runCatching {
            ...
            val roomTrack = selectRoomTrack(tracks, languages, preferManual)
            val rawVtt = downloader.fetchText(roomTrack.content, url)
            val cleanText = SubtitleFormatter.format(
                SubtitleParser.parseWebVtt(rawVtt),
